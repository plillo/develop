...
import it.hash.osgi.business.promotion.SpecialPrice;
...
public class PromotionServicePersistenceImpl implements PromotionServicePersistence {
	...
	public Map<String, Object> addPromotion(Promotion promotion) {
		...
		if ((int) result.get("matched") == 0) {
			...
			DBObject created = promotionCollection.findOne(promotionToDBObject(promotion), new BasicDBObject("logo", false));
...
*/
	...
	public Map<String, Object> getBusiness(Map<String, Object> business, boolean withLogo) {
		...
		if (business.containsKey("uuid") && business.get("uuid") != null) {
			if(withLogo)
				found = promotionCollection.findOne(new BasicDBObject("uuid", business.get("uuid")));
			else
				found = promotionCollection.findOne(new BasicDBObject("uuid", business.get("uuid")), new BasicDBObject("logo", false));
		...
		if (business.containsKey("_id") && business.get("_id") != null) {
			if(withLogo)
				found = promotionCollection.findOne(new BasicDBObject("_id", business.get("_id")));
			else
				found = promotionCollection.findOne(new BasicDBObject("_id", business.get("_id")), new BasicDBObject("logo", false));
		...
		if (business.containsKey("fiscalCode") && business.get("fiscalCode") != null) {
			if(withLogo)
				found = promotionCollection.findOne(new BasicDBObject("fiscalCode", business.get("fiscalCode")));
			else
				found = promotionCollection.findOne(new BasicDBObject("fiscalCode", business.get("fiscalCode")), new BasicDBObject("logo", false));
		...
		if (business.containsKey("name") && business.get("name") != null) {
			if(withLogo)
				found = promotionCollection.findOne(new BasicDBObject("name", business.get("name")));
			else
				found = promotionCollection.findOne(new BasicDBObject("name", business.get("name")), new BasicDBObject("logo", false));
		...
		if (business.containsKey("pIva") && business.get("pIva") != null) {
			if(withLogo)
				found = promotionCollection.findOne(new BasicDBObject("pIva", business.get("pIva")));
			else
				found = promotionCollection.findOne(new BasicDBObject("pIva", business.get("pIva")), new BasicDBObject("logo", false));
...
*/
	...
	public synchronized Map<String, Object> updateBusiness(String uuid, Business business) {
		...
		if (response == null) {
			...
			DBObject updated = promotionCollection.findOne(new BasicDBObject("uuid", uuid), new BasicDBObject("logo", false));
	...
	public Map<String, Object> updateBusinessLogo(String uuid, String type, byte[] encodeBase64) {
		...
		// retrieve
		DBObject updated = promotionCollection.findOne(new BasicDBObject("uuid", uuid));
	...
	private synchronized Map<String, Object> deleteBusiness(Business business) {
		...
		if ((int) response.get("matched") == 1) {
			...
			WriteResult wr = promotionCollection.remove(Dbo);
			if (wr.getN() == 1) {
	...
	public Map<String, Object> follow(String businessUuid, String userUuid) {
		...
		WriteResult wr = promotionCollection.update(searchQuery, updatedDocument);
	...
	public Map<String, Object> unFollow(String businessUuid, String actual_user_uuid) {
		...
		WriteResult wr = promotionCollection.update(searchQuery, new BasicDBObject("$pull", update));
		if (wr.getN() == 0)
			response.put("update", false);
		else
			response.put("update", true);
	...
	public List<Business> retrieveOwnedByUser(String uuid, boolean withLogo) {
		if (uuid != null) {
			DBCursor cursor;
			if(withLogo)
				cursor = promotionCollection.find(new BasicDBObject("owner", uuid));
			else
				cursor = promotionCollection.find(new BasicDBObject("owner", uuid), new BasicDBObject("logo", false));
	...
	public List<Business> retrieveFollowedByUser(String uuid, boolean withLogo) {
		if (uuid != null) {
			...
			if(withLogo)
				...
				cursor = promotionCollection.find(new BasicDBObject("followers", uuid), new BasicDBObject("logo", false));
	...
	public List<Business> retrieveNotFollowedByUser(String userUuid, String search, boolean withLogo) {
		...
		DBCursor cursor;
		if(withLogo)
			cursor = promotionCollection.find(query);
		else
			cursor = promotionCollection.find(query, new BasicDBObject("logo", false));
	...
	*/
	...
	public Map<String, Object> getPromotion(Map<String, Object> promotion) {
		...
		/*	else
				found = promotionCollection.findOne(new BasicDBObject("uuid", promotion.get("uuid")), new BasicDBObject("logo", false));
*/
			if (found != null) {
	...
	private List<Promotion> getPromotionByBusinessName(String Name) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	private List<Promotion> getPromotionByBusinessUuid(String uuid) {
		// TODO Auto-generated method stub
		return null;
	}
